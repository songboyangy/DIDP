...
```shell
python run.py -data_name memetracker --prefix exp --gpu 5 -batch_size 64 --lr 0.001 --diff_lr 0.0001 --steps 50 --sampling_steps 10 --noise_scale 0.1 --ssl_alpha 0.01 --inter --diff_alpha 0.1
```
